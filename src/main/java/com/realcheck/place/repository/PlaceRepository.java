...
public interface PlaceRepository extends JpaRepository<Place, Long> {
        ...
        /**
         * [1] 위도(lat), 경도(lng), 반경(m) 기준 근처 모든 장소 조회
        ...
        /**
         * 관리자용
         * [1] 장소 이름에 특정 키워드가 포함된 항목 검색 (대소문자 무시)
         ...
         * [2] 승인된 장소 중 키워드 포함된 장소 검색 (대소문자 무시)
         */
        @Query("""
                         SELECT p FROM Place p
                         WHERE p.isApproved = true

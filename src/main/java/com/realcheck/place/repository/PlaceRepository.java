...
public interface PlaceRepository extends JpaRepository<Place, Long> {
        ...
        /**
         * [3-8] 상태별 장소 수 카운트
         * AdminStatsService: getPlaceStatusCounts
         * - 각각 관리자 통계 API (/api/admin/stats/places/status)에서 사용
         */
        long countByIsApproved(boolean approved); // 승인된 장소 수

        long countByIsRejected(boolean rejected); // 반려된 장소 수

        long countByIsApprovedAndIsRejected(boolean approved, boolean rejected); // 펜딩 장소 수

        /**
         * [3-9] 월별 장소 등록 수 통계
         * AdminStatsService: getMonthlyPlaceRegistrations
         * - 관리자 대시보드에 월별 그래프 렌더링용
         */
        @Query("""
                        ...
                        """)
        List<MonthlyStatDto> countMonthlyRegistrations();
